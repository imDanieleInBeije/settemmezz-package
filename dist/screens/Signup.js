...
function Signup(props) {
  ...
  function signupButtonPress() {
    return _signupButtonPress.apply(this, arguments);
  }
  function _signupButtonPress() {
    _signupButtonPress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _authApi.signUpApi)(user.email, user.password, user.username);
            case 2:
