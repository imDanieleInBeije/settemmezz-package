...
var _authApi = require("../services/api/authApi");
...
function Login(props) {
  ...
  function signinButtonPress() {
    return _signinButtonPress.apply(this, arguments);
  }
  function _signinButtonPress() {
    _signinButtonPress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _authApi.signInApi)(user.email, user.psw);
            case 2:
              result = _context.sent;
              console.log(result.data);
              (0, _Storage.setInStorage)("userID", result === null || result === void 0 ? void 0 : (_result$data = result.data) === null || _result$data === void 0 ? void 0 : _result$data.id);
              (0, _Storage.setInStorage)("token", result === null || result === void 0 ? void 0 : (_result$data2 = result.data) === null || _result$data2 === void 0 ? void 0 : _result$data2.token);
              (0, _Storage.setInStorage)("refreshToken", result === null || result === void 0 ? void 0 : (_result$data3 = result.data) === null || _result$data3 === void 0 ? void 0 : _result$data3.refreshToken);
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    source: isDesktop ? require('../assets/images/bg-login-desktop.jpg') : require('../assets/images/bg-login-mobile.jpg'),
    resizeMode: "cover",
    style: [styles.bg, isDesktop ? styles.bgDesktop : styles.bgMobile]
    ...
    behavior: "padding"
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, null, /*#__PURE__*/_react.default.createElement(_CrossInputBox.default, {
