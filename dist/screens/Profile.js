...
function Profile(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _Storage.getFromStorage)("userID");
            case 2:
              id = _context.sent;
              _context.next = 5;
              return (0, _authApi.getUserApi)(id);
            case 5:
              result = _context.sent;
              user.name = result === null || result === void 0 ? void 0 : (_result$data = result.data) === null || _result$data === void 0 ? void 0 : _result$data.username;
              user.email = result === null || result === void 0 ? void 0 : (_result$data2 = result.data) === null || _result$data2 === void 0 ? void 0 : _result$data2.email;
              user.password = result === null || result === void 0 ? void 0 : (_result$data3 = result.data) === null || _result$data3 === void 0 ? void 0 : _result$data3.password;
              setState(_objectSpread(_objectSpread({}, state), {}, {
                name: user.name,
                email: user.email,
                password: user.password,
                score: result === null || result === void 0 ? void 0 : (_result$data4 = result.data) === null || _result$data4 === void 0 ? void 0 : _result$data4.score
              }));
              console.log(id, user);
            case 11:
            case "end":
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  }, "I MIEI DATI"), /*#__PURE__*/_react.default.createElement(_CrossInputBox.default, {
    value: state.name,
    callbackChange: getName,
    addStyles: !isDesktop && styles.inputLarge
    ...
    callbackPress: updateUser
  })), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.subtitle
  }, "PARTITE VINTE: ", state.score)), props.children);
}
